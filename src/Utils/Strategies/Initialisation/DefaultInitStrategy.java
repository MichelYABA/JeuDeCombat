 ...
 */
/*
    Strategie d'initialisation par defaut 
*/
public class DefaultInitStrategy implements InitStrategy{

    private int[][] g;
    private int nc;
    private int[] tab;
    //Positions possibles des murs dans la grille
    private final int[][] posMur ={{2, 3}, {3,3}, {5, 2}, {6,2}, {2,11}, {2,12}, {7,13}, {7,14}, 
                                    {10,4}, {10,5}, {13,12}, {12,12}};
     ...
     * @param grille
     */
    public DefaultInitStrategy(int[][] grille){
        this.g = grille;
    }
    ...
    /* Intialisation des murs des 4 cotes de la grille*/            
       
        //on place les murs sur toutes les colonnes de la premiere ligne
        for(int j=0; j<(this.g[0].length); j++){
            g[0][j] = Definitions.MUR;
        }
